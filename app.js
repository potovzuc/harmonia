...
client.on('guildMemberAdd', guildMember => {
    guildMember.guild.channels.cache.get('988069007540228137').send(`**<@${guildMember.user.id}> Sunucuya Katıldı!**`);
});   
 */

client.on('guildMemberRemove', guildMember => {
    guildMember.guild.channels.cache.get('912697121793265694').send(`**<@${guildMember.user.id}> Sunucuyu Terk etti!**`);
});
